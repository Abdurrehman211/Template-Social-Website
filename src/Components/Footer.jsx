          ...
          <section>
            <div className="row">
              ...
              <div className="col-md-4 col-lg-3 col-xl-3  mt-3">
                ...
                <a href="mailto:uniquehomecareinc@gmail.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" , color: "white"}}><i className="fas fa-envelope mr-3" style={{marginRight: "10px"}}></i>info.triodevelopers@gmail.com</a><br /><br />
